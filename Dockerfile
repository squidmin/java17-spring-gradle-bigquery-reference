...
ARG GCP_DEFAULT_PROJECT_ID
ARG GCP_DEFAULT_DATASET
ARG GCP_DEFAULT_TABLE
...
ENV GCP_DEFAULT_PROJECT_ID=${GCP_DEFAULT_PROJECT_ID}
ENV GCP_DEFAULT_DATASET=${GCP_DEFAULT_DATASET}
ENV GCP_DEFAULT_TABLE=${GCP_DEFAULT_TABLE}
